...
namespace ConsoleApp17
{
    class Program
    {
        static void OutPutdec(List<decimal> list)
        {
        ...
        {
            ////Задача 1. Создайте коллекцию(6 вариант) из шести элементов
            ...
            //List<Decimal> list = new List<Decimal> { 1m,2m,3m,4m,5m,6m,7m,8m,9m,10m,11m,12m,13m,14m,15m,16m,17m,18m,19m,20m };
